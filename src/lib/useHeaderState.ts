    ...
    () => [
      {
        href: "/",
        label: "BERANDA",
        handler: (e: React.MouseEvent) => handleInternalNavigation("/", e),
      },
      {
        href: "/proyek",
        label: "PROYEK",
        handler: (e: React.MouseEvent) =>
          handleInternalNavigation("/proyek", e),
      },
      {
        href: "/awards",
        label: "AWARDS",
        handler: (e: React.MouseEvent) =>
          handleInternalNavigation("/awards", e),
      },
      {
        href: "/blog",
        label: "BLOG",
        handler: (e: React.MouseEvent) => handleInternalNavigation("/blog", e),
      },
      {
        href: "/tentang-kami",
        label: "TENTANG KAMI",
        handler: (e: React.MouseEvent) =>
          handleInternalNavigation("/tentang-kami", e),
      },
