            ...
            >
                <div className="relative h-48 sm:h-64 lg:h-96 overflow-hidden rounded-[1rem] sm:rounded-[1.5rem]">
                    ...
                    <div className="absolute bottom-3 sm:bottom-4 right-3 sm:right-4">
                        <button className="bg-white/20 hover:bg-white/30 text-white px-2 sm:px-4 py-1 sm:py-2 rounded-lg sm:rounded-xl text-xs sm:text-sm font-medium transition-all duration-200 backdrop-blur-md border border-white/20">
                            {service.category}
                        </button>
                    </div>
                </div>
